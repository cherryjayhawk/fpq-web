...
function Testimonial() {
  return (
    <div className="w-full min-h-[80vh] flex flex-col items-center justify-evenly bg-gradient-to-br from-cyan-500 from-60% to-teal-400 -translate-y-96 md:-translate-y-16">
